...
int Room_attack(void* self, int damage)
{
	...
	if (monster) {
		...
		printf("You flail wildly entering the room. It is empty.");
		return 0;}
}
...
int process_input(Map* game)
{
	...
	char ch = getchar();
	getchar(); //Swallow ENTER (any other key works too I guess)
...
{
	srand(time(NULL)); //Seeding with curret time or something
